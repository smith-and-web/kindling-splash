...
This post covers the best Plottr alternatives in 2026, ranked by what they do well and who they're for. If you are still deciding on Plottr itself, start with our [Plottr review](/blog/plottr-review/).

Plottr, Scrivener, Dabble, and Campfire prices checked 12 September 2026 in USD before tax. Follow the linked vendor pages for billing terms and current offers.
...
- **Price** -- The [Plottr desktop plan](https://plottr.com/pricing/) is $60/year or $150 lifetime. Free alternatives exist.
...
[Download kindling free &rarr;](/download/)

## 2. Scrivener -- best for heavy-research novels

**Price:** [$59.99 per desktop platform](https://www.literatureandlatte.com/crossgrading) · **Platform:** macOS, Windows, iOS
...
See our deeper [Plottr vs Scrivener comparison](/plottr-vs-scrivener/) or the [free Scrivener alternative guide](/free-scrivener-alternative/) for details.
...
**Price:** [Free tier; displayed $12/month offer for paid access](https://www.campfirewriting.com/pricing) · **Platform:** Web

Campfire organizes its worldbuilding and manuscript tools into modules; its current paid plan includes access to all modules. It's strongest for fantasy and sci-fi writers tracking dozens of characters, locations, and magic systems.
...
**Price:** [$19--$49/month; $699 lifetime Author access](https://www.dabblewriter.com/pricing) · **Platform:** Web, macOS, Windows

Dabble is the most direct Plottr-to-drafting replacement on the list. It combines plotting, drafting, and goal tracking in one clean interface. Subscription and lifetime Author plans are available.
...
1. Locate your saved Plottr `.pltr` project file.
2. Open kindling and choose **Import &rarr; Plottr**.
...
You keep the plotting work you already did and gain a drafting environment built around it. Check the [supported import details](/docs/importing-projects/#plottr-pltr), then follow our guide to [turning an outline into a first draft](/blog/how-to-turn-your-novel-outline-into-a-first-draft/).
...
[Download kindling Writer -- free &rarr;](/download/)
